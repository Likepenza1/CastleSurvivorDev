...
{
    public sealed class StringDictionaryItemDiffFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::DataTypes.Collections.StringDictionaryItemDiff>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::DataTypes.Collections.StringDictionaryItemDiff value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
        ...
        public global::DataTypes.Collections.StringDictionaryItemDiff Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::DataTypes.Collections.StringDictionaryItemDiff(__Key__, __CollectionDiffType__, __DiffItem__);
            reader.Depth--;
            return ____result;
        }
    }
