...
{
    public sealed class RangedAttackTypeFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Descriptions.Units.RangedAttackType>
    {
        // ProjectileSpeed
        private static global::System.ReadOnlySpan<byte> GetSpan_ProjectileSpeed() => new byte[1 + 15] { 175, 80, 114, 111, 106, 101, 99, 116, 105, 108, 101, 83, 112, 101, 101, 100 };
        // Projectile
        private static global::System.ReadOnlySpan<byte> GetSpan_Projectile() => new byte[1 + 10] { 170, 80, 114, 111, 106, 101, 99, 116, 105, 108, 101 };
        // Range
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Descriptions.Units.RangedAttackType value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
            ...
            writer.WriteRaw(GetSpan_Projectile());
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Descriptions.Types.AddressableAsset<global::UnityEngine.GameObject>>(formatterResolver).Serialize(ref writer, value.Projectile, options);
        ...
        public global::Descriptions.Units.RangedAttackType Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::Descriptions.Units.RangedAttackType();
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 15:
                        ...
                        continue;
                    case 10:
                        if (!global::System.MemoryExtensions.SequenceEqual(stringKey, GetSpan_Projectile().Slice(1))) { goto FAIL; }

                        ____result.Projectile = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Descriptions.Types.AddressableAsset<global::UnityEngine.GameObject>>(formatterResolver).Deserialize(ref reader, options);
                        continue;
                    case 5:
